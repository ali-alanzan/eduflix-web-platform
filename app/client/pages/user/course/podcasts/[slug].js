...
const SingleCoursePodcastsUser = () => {
        ...
        <StudentRoute>
            ...
            >
                ...
                >
                    <Drawer variant="permanent" open={open}>
                        <DrawerHeader>
                        {open && <Typography sx={{flexGrow: 1   }} variant="h5" align="center">Lessons</Typography>}
            ...
            >
                ...
                {clicked == -1 ? (<>
                    ...
                    sx={{justifyContent: 'flex-end', flexGrow: 1, maxWidth: '100%'}}
                    >
                        <Grid item >
