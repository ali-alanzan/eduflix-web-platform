                    ...
                    courses.map(course => (
                        <Grid item key={course.slug} sx={{ marginTop: '1rem'}}>
                            ...
                            <CardHeader
                                ...
                                title={<Link href={`/instructor/course/view/${course.slug}`} passHref><Typography sx={{color: 'inherit', textDecoration: 'none'}} variant="h6" component="a">{course.title}</Typography></Link>}
